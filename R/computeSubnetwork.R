...
#'@usage computeSubnetwork(edgelist, nodelist, pval, fc, fdr, method, returnas)
...
#'@export
computeSubnetwork <- function(edgelist, nodelist=NULL, pval, fc, fdr=0.05, method="bionet", returnas="dataframe") UseMethod("computeSubnetwork")
#'@export
computeSubnetwork.default <- function (edgelist, nodelist=NULL, pval, fc, fdr=0.05, method="bionet", returnas="dataframe"){
  out <- tryCatch(
    {
